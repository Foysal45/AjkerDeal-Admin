...
import com.ajkerdeal.app.ajkerdealadmin.databinding.FragmentOrderWiseMerchantListBinding
...
class OrderWiseMerchantListFragment : Fragment() {
    private var binding: FragmentOrderWiseMerchantListBinding? = null
    private  var dataAdapter: OrderWiseMerchantListAdapter = OrderWiseMerchantListAdapter()
    ...
    companion object {
        fun newInstance(): OrderWiseMerchantListFragment = OrderWiseMerchantListFragment().apply {}
        val tag: String = OrderWiseMerchantListFragment::class.java.name
    }

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return FragmentOrderWiseMerchantListBinding.inflate(inflater, container, false).also {
            binding = it
        }.root
    }
