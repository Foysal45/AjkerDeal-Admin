...
import com.ajkerdeal.app.ajkerdealadmin.databinding.ItemViewChatReceiverBinding
import com.ajkerdeal.app.ajkerdealadmin.databinding.ItemViewChatSenderBinding
...
class ChatAdapter(private val userId: String) : RecyclerView.Adapter<RecyclerView.ViewHolder>()  {
    ...
    var onMessageClicked: ((model: ChatData, view: TextView) -> Unit)? = null
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is ViewModelSender) {
            ...
            if (!isValidDTCodeChat(model.message)){
                binding.message.fixTextSelection()
            }
    ...
    inner class ViewModelSender(val binding: ItemViewChatSenderBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        init {
            ...
            binding.message.setOnClickListener {
                ...
                if (absoluteAdapterPosition in 0..dataList.lastIndex)
                    onMessageClicked?.invoke(dataList[absoluteAdapterPosition], binding.message)
