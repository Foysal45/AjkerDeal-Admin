package com.ajkerdeal.app.ajkerdealadmin.services
...
class LocationUpdatesService : Service() {
    ...
    private val NOTIFICATION_ID = 21410
    ...
    companion object {
        val PACKAGE_NAME = "com.ajkerdeal.app.ajkerdealadmin.services.LocationUpdatesService"
    ...
    override fun onUnbind(intent: Intent?): Boolean {
        if (!changingConfiguration) {
            ...
            val activityPendingIntent = PendingIntent.getActivity(this, 21411, activityIntent, PendingIntent.FLAG_UPDATE_CURRENT)
            ...
            notification = NotificationCompat.Builder(this, channelID)
                ...
                .addAction(R.drawable.ic_notification_ad, "Open App", activityPendingIntent)
