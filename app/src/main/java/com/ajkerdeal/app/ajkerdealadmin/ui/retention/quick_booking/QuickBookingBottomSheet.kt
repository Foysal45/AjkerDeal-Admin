...
import com.ajkerdeal.app.ajkerdealadmin.databinding.FragmentQuickBookingBinding
import com.ajkerdeal.app.ajkerdealadmin.ui.retention.collection_location.CollectionLocationSelectionBottomSheet
...
class QuickBookingBottomSheet  : BottomSheetDialogFragment() {
    ...
    companion object {
        ...
        fun newInstance(merchantId: Int): QuickBookingBottomSheet = QuickBookingBottomSheet().apply {
    ...
    private fun showCollectionLocationSelectionBottomSheet() {
        ...
        val dialog: CollectionLocationSelectionBottomSheet = CollectionLocationSelectionBottomSheet.newInstance(merchantId)
