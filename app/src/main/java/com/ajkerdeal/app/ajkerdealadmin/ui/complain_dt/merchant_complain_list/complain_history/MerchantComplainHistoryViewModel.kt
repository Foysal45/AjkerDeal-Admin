...
class MerchantComplainHistoryViewModel(private val repository: AppRepository): ViewModel() {
    ...
    fun getComplainHistory(bookingCode: Int): LiveData<List<ComplainHistoryData>> {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            val response = repository.getAllCommentsDTComplainForApp(bookingCode, 1)
