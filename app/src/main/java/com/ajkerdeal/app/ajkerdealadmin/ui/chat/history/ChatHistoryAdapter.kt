...
import com.ajkerdeal.app.ajkerdealadmin.databinding.ItemViewChatHistoryBinding
import com.ajkerdeal.app.ajkerdealadmin.utils.SessionManager
import com.ajkerdeal.app.ajkerdealadmin.utils.generateNameInitial
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        if (holder is ViewModel) {
            ...
            if (SessionManager.userId == 906){
                binding.title.text = HtmlCompat.fromHtml("${model.receiverName} <font color='#E84545'> (ID: ${model.receiverId})</font>", HtmlCompat.FROM_HTML_MODE_LEGACY )
