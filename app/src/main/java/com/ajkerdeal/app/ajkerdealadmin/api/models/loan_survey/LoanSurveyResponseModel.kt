...
data class LoanSurveyResponseModel(
    @SerializedName("age")
    val age: String = "",
    @SerializedName("annualTotalIncome")
    val annualTotalIncome: Double = 0.0,
    ...
    val interestedAmount: Double = 0.0,
    ...
    val monthlyTotalAverageSale: Double = 0.0,
    @SerializedName("monthlyTotalCodAmount")
    val monthlyTotalCodAmount: Double = 0.0,
    @SerializedName("nidNo")
    val nidNo: String = "",
    @SerializedName("othersIncome")
    val othersIncome: Double = 0.0,
